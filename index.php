	...
	<form method="post">
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username="eliazar.rodriguez.velasco@gmail.com";//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword="Realmadridyya7";//Tu contraseña de gmail
				$mail_addAddress="eliazar.rodriguez.velasco@gmail.com";//correo electronico que recibira el mensaje
